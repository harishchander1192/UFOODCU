...
<body>
    ...
    include 'cons.php';
    $id = $_REQUEST['pid'];
    $selectquery = "select * from singupacc where id='$id' and accStatus='Reject'";
    ...
    ?>
        ...
        <aside class="profile-card">
            ...
            <div class="profile-bio">
                <p>
                    <?php echo "<b> " . $fname . " " . $lname . ",</b> Requested for <b>" . $role . "</b> role in our site.With Uasername:-<b>" . $uname . "</b>, E-Mail Id:-<b>" . $email . " </b>and password is:-<b>".$pass."</b> for accpet this requst please press on Accpet button or press Reject button for reject this account. " ?>
                </p>
                <br>
                ...
                <a href="http://localhost/blogs/manageaccount.php"> Back </a>
            </div>
            <?php

        } else {
            echo "No data data found";
        }
        ...
        if (isset($_POST['submit'])) {
            ...
            $statusquery = "UPDATE singupacc SET accStatus = '$status' WHERE id = $id ";

            if (mysqli_query($conn, $statusquery)) {
            ?>
                <script>
                    alert('Admin Accpet/Reject your account...!!');
                </script>
