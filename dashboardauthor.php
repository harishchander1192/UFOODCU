...
<body>
  ...
  <div class="w3-top">
    <div class="w3-bar w3-white w3-wide w3-padding w3-card">
      <a href="http://localhost/blogs/dashboardauthor.php" class="w3-bar-item w3-button"><b>HARI</b> Blogs</a>
      <!-- Float links to the right. Hide them on small screens -->
      <div class="w3-right w3-hide-small">
        <a href="http://localhost/blogs/manage.php" class="w3-bar-item w3-button">Manage blog </a>
        <a href="http://localhost/blogs/addblog.php" class="w3-bar-item w3-button" label for="blog">Add blog</a>
        <div class="w3-bar-item w3-button">
          <a href="http://localhost/blogs/logout1.php?id=<?php echo md5($_SESSION['newid']); ?>" class="label">
            <?php
                  ...
                  <div class="w3-col l4">
                    ...
                    <div class="w3-card w3-margin">
                      ...
                      <div class="w3-container w3-white">
                        <p>
                          <span class="w3-tag w3-black w3-margin-bottom"><a href="#">Travel</a></span>
                          <span class="w3-tag w3-black w3-margin-bottom"><a href="#">Temple<a></span>
